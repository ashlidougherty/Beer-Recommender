...
For a more indepth look at my code and other recommendations you can explore my [ContentBased Notebook](./ContentBased.ipynb) or use the system for yourself as a [streamlit app](https://ashlidougherty-beer-recommender-app-ykyxz6.streamlitapp.com/).

## Collaborative Filtering 
<img src=./images/collab.png alt='collab' width="600"/>
...
For a more indepth look at my code and other recommendations you can explore my [CollabFilter Notebook](./CollabFilter.ipynb)
